...
public class ConsistentHashLoadBalancer extends AbstractLoadBalancer {
     ...
     * @return void
     * @Author mSc
     * @Description 根据可用invoker列表构建(重建)哈希环
     ...
     * @return byte[]
     * @Author mSc
     * @Description 使用MD5算法得到长度为16的字节数组, 保证hash函数的平衡性(分布均匀)
     * @Param [key]
     **/
     ...
     * @return long
     * @Author mSc
     * @Description 将128位的md5散列字节数组转换成long型整数
